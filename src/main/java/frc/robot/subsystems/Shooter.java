...
public class Shooter extends SubsystemBase {
    ...
    // }
    // public Shooter() {
    // LeftRight = new NEO(Constants.RobotConstants.TurretMotorID,
    // MotorType.kBrushless);
    // UpDown = new NEO(0, MotorType.kBrushless);
    // setDefaultCommand(new ShooterControl(this)); // temporary commented out to
    // see if solves null pointer exceptions
