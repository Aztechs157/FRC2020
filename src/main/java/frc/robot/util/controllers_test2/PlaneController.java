...
public class PlaneController extends ControllerModel {
    ...
    public static final ButtonDef RIGHT_HAND_BUMPER = new ButtonDef(0, 1);

    public static final ButtonDef RIGHT_HAND_MID_DOWN = new ButtonDef(0, 2);
    public static final ButtonDef RIGHT_HAND_MID_UP = new ButtonDef(0, 3);
    public static final ButtonDef RIGHT_HAND_MID_LEFT = new ButtonDef(0, 4);
    public static final ButtonDef RIGHT_HAND_MID_RIGHT = new ButtonDef(0, 5);

    public static final ButtonDef RIGHT_HAND_TOP_LEFT = new ButtonDef(0, 6);
    public static final ButtonDef RIGHT_HAND_BOTTOM_LEFT = new ButtonDef(0, 7);

    public static final ButtonDef RIGHT_HAND_FAR_BOTTOM_LEFT = new ButtonDef(0, 8);
    public static final ButtonDef RIGHT_HAND_FAR_BOTTOM_RIGHT = new ButtonDef(0, 9);

    public static final ButtonDef RIGHT_HAND_BOTTOM_RIGHT = new ButtonDef(0, 10);
    public static final ButtonDef RIGHT_HAND_TOP_RIGHT = new ButtonDef(0, 11);
    // #endregion
}
